...
ifeq ($(BR2_TARGET_OPENSBI_PLAT_REF),y)
	OPENSBI_PLAT_NAME = $(call qstrip,$(BR2_TARGET_OPENSBI_PLAT_REF_NAME))
	OPENSBI_MAKE_ENV += PLATFORM=$(OPENSBI_PLAT_NAME)
endif 

ifeq ($(BR2_TARGET_OPENSBI_PLAT_EXT),y)
	OPENSBI_PLAT_EXT_DIR = $(call qstrip,$(BR2_TARGET_OPENSBI_PLAT_EXT_DIR))
...
$(info OPENSBI_PLAT=$(OPENSBI_PLAT))
